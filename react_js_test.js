const hello_yog=[
        {
                text:"Q1 . What is React? ",
                option:["A library for building user interfaces","A database","A programming Language","A fraamework for backend developemnt"],
                answer_of_this:"A library for building user interfaces"
        },
        {
                text:"Q2 . Who developed React.Js? ",
                option:["Google","Facebook","Twitter","Microsoft"],
        ...
        {
                text:"Q26 . How many root elements can a React component return?",
                option:["Unlimited","One","Two","None"],
                answer_of_this:"One"
        },
        {
                text:"Q27 . Which one is NOT a lifecyle method ? ",
                option:["componentDivMount","componentWillUnmount","componentLoop","componentDidUpdate"],
                answer_of_this:"componentLoop"
        },
        {
                text:"Q28 . What is the primary purpose of lifting state up in React?",
        ...
        {
                text:"Q29 . How does React identify which teams have changed , added , or removed?",
                option:["comparing all elements","Using keys","Using IDs","Random Checks"],
                answer_of_this:"Using keys"
        },
        {
                text:"Q30 . What is reconcilation in React?",
