const hello_yog=[
        {
                ...
                option:["Hyper Text Markup Language","Home Tool Markup Language","Hyperlinks and Text Markup Language","None of the Above"],
                answer_of_this:"Hyper Text Markup Language"
        },
        {
                text:"Q2 . Who is developed by HTML?",
                option:["Tim berners-Lee","Dennis Ritche","Charles Babbage","Brendan Eich"],
                answer_of_this:"Tim berners-Lee"
        },
        {
                text:"Q3 . What is the correct HTML element for the largest heading?",
                option:["head","h6","heading","h1"],
                answer_of_this:"h1"
        },
        {
                text:"Q4 . What is the correct HTML element for inserting a line break?",
                option:["br","lb","break","b"],
                answer_of_this:"br"
        },
        {
                text:"Q5 . Which tah is used to define a hyperlink in a HTML? ",
                option:["a","link","href","hyperlink"],
                answer_of_this:"a"
        },
        {
                text:"Q6 . HTML tags are enclosed in : ",
                option:["{}","[]","()","<>"],
                answer_of_this:"<>"
        },
        {
                text:"Q7 . What does the <em>tag stands for?",
                option:["Emphasis","Email","Embed","Entry"],
                answer_of_this:"Emphasis"
        },
        {
                text:"Q8 . Which tag is used to group block-elements and format them with CSS?",
                option:["div","span","section","form"],
                answer_of_this:"div"
        },
        {
                text:"Q9 . The <span> tag is used for :  ",
                option:["Block-level styling","Grouping inline elements","Creating sections","Creating lists"],
                answer_of_this:"Creating sections"
        },
        {
